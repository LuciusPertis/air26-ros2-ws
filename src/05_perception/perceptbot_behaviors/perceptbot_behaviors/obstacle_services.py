"""obstacle_services — the SERVICE + ACTION side of behaviour 3 (carried over from 02).
...
exactly what services and actions are for. This node provides both:
  ...
  service  /check_openings  (perceptbot_interfaces/CheckOpenings)
      instant request/response: are left/right open right now? (one question, one answer)
  action   /escape_obstacle  (perceptbot_interfaces/EscapeObstacle)
